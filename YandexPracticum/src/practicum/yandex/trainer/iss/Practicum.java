...
class Practicum { // доступ к любым изменениям класса запрещён, при проверке будет подставлен
					// оригинальный файл
	...
	public static void main(String[] args) {
		...
		if ((spaceStation.oxygenLevel < 0) || (spaceStation.getEnergyConsumption() > spaceStation.energyReserve)
