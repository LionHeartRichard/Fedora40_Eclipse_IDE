...
class Practicum {
	...
	private static final List<Validator> passwordValidators = List.of(new PasswordLengthValidator(5),
	...
	private static void checkValidatorRules(final List<Validator> validators, final String value)
